...
for i=(1:size(coordinates,1))
    ...
    [convxy(i,1),convxy(i,2)]=convert_coordinates(coordinates(i,2),coordinates(i,1));
    %[convxy(i,1),convxy(i,2)]=convert_merc_coordinates(coordinates(i,1),coordinates(i,2),pixels,pixels);
    %convxy(i,1)=(convxy(i,1)-left)*(1368/(right-left));
    %convxy(i,2)=(convxy(i,2)-upper)*(1480/(bottom-upper));
end
figure
